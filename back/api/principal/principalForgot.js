...
const Login = require('../../models/Principal/PrincipalSchema');
const emailTransporter = require('../../nodemailer');
const app = express();
app.use(bodyParser.json());

app.post('/principal/sendverificationcode', async (req, res) => {
...
app.post('/principal/verifycodeandchangepassword', async (req, res) => {
