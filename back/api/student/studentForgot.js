...
const Login = require('../../models/Student/UserSchema');
const emailTransporter = require('../../nodemailer');
const app = express();
app.use(bodyParser.json());

app.post('/student/sendverificationcode', async (req, res) => {
...
app.post('/student/verifycodeandchangepassword', async (req, res) => {
