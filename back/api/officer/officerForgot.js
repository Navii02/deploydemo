...
const Login = require('../../models/Officer/OfficerSchema');
const emailTransporter = require('../../nodemailer');
const app = express();
app.use(bodyParser.json());

app.post('/officer/sendverificationcode', async (req, res) => {
...
app.post('/officer/verifycodeandchangepassword', async (req, res) => {
