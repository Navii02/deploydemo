...
const Login = require('../../models/Faculity/FaculitySchema');
const emailTransporter = require('../../nodemailer');
const app = express();
app.use(bodyParser.json());

app.post('/faculty/sendverificationcode', async (req, res) => {
...
app.post('/faculty/verifycodeandchangepassword', async (req, res) => {
